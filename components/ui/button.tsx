...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-white hover:shadow-glow hover:-translate-y-0.5 active:translate-y-0",
        destructive: "bg-gradient-danger text-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        outline: "btn-glass hover:-translate-y-0.5 active:translate-y-0",
        ...
        success: "bg-gradient-success text-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        premium: "bg-gradient-primary text-white hover:shadow-glow hover:-translate-y-0.5 active:translate-y-0 relative overflow-hidden",
      },
      size: {
